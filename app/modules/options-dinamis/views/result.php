	...
	<div class="card-body">
		...
		if (!$result) {
			...
			foreach ($result as $key => $val) {
				...
				$nama_penanggung_jawab = @$val['nama_penanggung_jawab'] ? '<ol><li>' . join( '</li><li>', explode(',', $val['nama_penanggung_jawab'])) . '</li></ol>' : '';
				$nama_penghadap = @$val['nama_penghadap'] ? '<ol><li>' . join( '</li><li>', explode(',', $val['nama_penghadap'])) . '</li></ol>' : '';
