...
<div class="card">
	...
	<div class="card-body">
		...
		<span style="display:none" id="url-delete"><?=BASE_URL . 'menu?action=delete'?></span>
		<span style="display:none" id="url-edit"><?=BASE_URL . 'menu?action=edit'?></span>
		<span style="display:none" id="url-detail"><?=BASE_URL . 'menu?action=menu_detail&ajax=true&id='?></span>
	</div>
</div>