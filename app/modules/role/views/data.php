<div class="card">
	...
	<div class="card-body">
		<a href="?action=add" class="btn btn-success btn-xs"><i class="fa fa-plus pe-1"></i> Tambah Role</a>
		<hr/>
		<?php 
		if (!$result) {
			...
			foreach ($result as $key => $val) {
				...
				echo '</td>
						...
						<td>
							...
							<a href="?module=role&action=edit&id='. $val['id_role'] .'" class="btn btn-success btn-xs me-1"><i class="fa fa-edit"></i>&nbsp;Edit</a>
